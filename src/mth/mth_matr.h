...
namespace mth
{
  template<class Type>
    ...
    public:
      ...
      {
        EvaluateInverseMatrix();
        return matr( InvA[0][0], InvA[0][1], InvA[0][2], InvA[0][3],
                     InvA[1][0], InvA[1][1], InvA[1][2], InvA[1][3],
                     InvA[2][0], InvA[2][1], InvA[2][2], InvA[2][3],
                     InvA[3][0], InvA[3][1], InvA[3][2], InvA[3][3] );
